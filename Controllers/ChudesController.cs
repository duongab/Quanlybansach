...
namespace Quanlybansach.Controllers
{
    public class ChudesController : Controller
    {
        ...
        private void CopyDataByBulk(DataTable dt)
        {
            ...
            con.Open();
            bulkcopy.DestinationTableName = "Chudes";
            bulkcopy.ColumnMappings.Add(0, "machude");
            bulkcopy.ColumnMappings.Add(1, "tenchude");
        ...
        public ActionResult DownloadFile()
        {
            ...
            byte[] fileBytes = System.IO.File.ReadAllBytes(path + "Chude.xlsx");
            //ten file khi download ve
            string fileName = "Chude.xlsx";
            //tra ve file
